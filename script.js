...
const holidays = [
    ...
    { date: '2027-02-05', name: '除夕' }, { date: '2027-02-06', name: '初一' },
    { date: '2027-02-07', name: '初二' }, { date: '2027-02-08', name: '初三' },
    { date: '2027-02-28', name: '和平紀念日' }, { date: '2027-03-01', name: '補假' },
    { date: '2027-04-04', name: '兒童節' }, { date: '2027-04-05', name: '清明節' },
    { date: '2027-05-01', name: '勞動節' }, { date: '2027-06-08', name: '端午節' },
    { date: '2027-09-15', name: '中秋節' }, { date: '2027-10-10', name: '國慶日' },
